...
<style>
body.example1 {
	background-image: url(<?php echo base_url('template/') . template() . "/images/bg_2.png"?>);
	/* height: 100%; 
				...
				<fieldset>
					<div class="form-group">
						<span class="input-icon"> <input type="text" class="form-control"
							...
							value="<?php echo $username; ?>" /><i class="fa fa-user"></i>
					...
					<div class="form-group form-actions">
						<span class="input-icon"> <input type="password"
							...
							value="<?php echo $password; ?>" /> <i class="fa fa-lock"></i>
							<a class="forgot"
							href="<?php echo base_url('administrator/forgot_password')?>"> I forgot
								my password </a>
					...
					<div class="form-actions">
						...
						<a class="btn btn-dark-grey" href="<?php echo base_url('administrator/home')?>">
