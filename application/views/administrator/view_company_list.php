<div class="main-container">
	...
	<section class="wrapper">
		<div class="container">
			...
			<?php if ($this->session->userdata('message') <> ''){?>
				...
				<div class="col-lg-12">
					...
					<div class="col-md-6" style="padding-left: 0px">
						<a href="<?php echo base_url('administrator/company_create')?>"
							class="btn btn-success">Add <?php echo $page;?></a>
					</div>
					<div class="col-md-6 text-right" style="padding-right: 0px">
						<form class="" id="searchform"
							action="<?php echo site_url('administrator/company'); ?>">
            ...
            if ($q != '') {
            ?>
                <a href="<?php echo site_url('administrator/company'); ?>" class="btn btn btn-bricky btn-squared"><i class="clip-close-3"></i></a>
            <?php } ?>
